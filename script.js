...
const BUILD_TIMESTAMP = '2025-12-23T22:50:11Z'; // Auto-updated on deployment
const APP_VERSION = '25.52.12'; // Auto-updated on deployment
        ...
        for (let i = 0; i < expenses.length; i++) {
            ...
            try {
                ...
                const fullExpense = await supabaseGet(TABLE_NAME, {
                    'id': `eq.${expense.id}`
                }, 1, 'id,Item,Year,Month,Day,Receipt');
